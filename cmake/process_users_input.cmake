...
# but are very helpful to verify any issues with code generation problems and/or off results.
option(TESTING_GENERATED "Include kernel unit tests as generated by yateto" ${TESTING})

option(COVERAGE "Generate targed for code coverage using lcob" OFF)

set(TESTING_COMMAND "" CACHE STRING "Command prefix to the test binary, so that CMake can list the tests")
set(TESTING_COMMAND_MPI "mpirun" CACHE STRING "Command to run the MPI tests; \"-n ${RANKS}\" will be added to it")
