...
option(MULTISETUP "Enable multiple setups compiled in a single binary" ON)

if (MULTISETUP)

option(ENABLE_ORDER_2 "" ON)
option(ENABLE_ORDER_3 "" ON)
option(ENABLE_ORDER_4 "" ON)
option(ENABLE_ORDER_5 "" ON)
option(ENABLE_ORDER_6 "" ON)
option(ENABLE_ORDER_7 "" ON)
option(ENABLE_ORDER_8 "" ON)

option(ENABLE_MATERIAL_ELASTIC "" ON)
option(ENABLE_MATERIAL_ANISOTROPIC "" ON)
option(ENABLE_MATERIAL_VISCOELASTIC "" ON) # for now, hard-coded to 3 mechanisms (might change)
...
set(ENABLED_ORDER)
set(ENABLED_MATERIAL)
set(ENABLED_PRECISION)

if (ENABLE_ORDER_2)
    list(APPEND ENABLED_ORDER 2)
endif()
if (ENABLE_ORDER_3)
    list(APPEND ENABLED_ORDER 3)
endif()
if (ENABLE_ORDER_4)
    list(APPEND ENABLED_ORDER 4)
endif()
if (ENABLE_ORDER_5)
    list(APPEND ENABLED_ORDER 5)
endif()
if (ENABLE_ORDER_6)
    list(APPEND ENABLED_ORDER 6)
endif()
if (ENABLE_ORDER_7)
    list(APPEND ENABLED_ORDER 7)
endif()
if (ENABLE_ORDER_8)
    list(APPEND ENABLED_ORDER 8)
endif()

if(ENABLE_MATERIAL_ELASTIC)
    list(APPEND ENABLED_MATERIAL "elastic")
endif()
if(ENABLE_MATERIAL_ANISOTROPIC)
    list(APPEND ENABLED_MATERIAL "anisotropic")
endif()
if(ENABLE_MATERIAL_VISCOELASTIC)
    list(APPEND ENABLED_MATERIAL "viscoelastic2")
endif()
if(ENABLE_MATERIAL_POROELASTIC)
    list(APPEND ENABLED_MATERIAL "poroelastic")
endif()
...
if (ENABLE_PRECISION_F32)
    list(APPEND ENABLED_PRECISION F32)
endif()
if (ENABLE_PRECISION_F64)
    list(APPEND ENABLED_PRECISION F64)
endif()

string(REPLACE ";" "," ENABLED_ORDER "${ENABLED_ORDER}")
string(REPLACE ";" "," ENABLED_MATERIAL "${ENABLED_MATERIAL}")
string(REPLACE ";" "," ENABLED_PRECISION "${ENABLED_PRECISION}")

else()

set(ENABLED_ORDER ${ORDER})
set(ENABLED_MATERIAL ${EQUATIONS})

if (PRECISION STREQUAL "single")
    set(ENABLED_PRECISION "F32")
else()
    set(ENABLED_PRECISION "F64")
endif()
