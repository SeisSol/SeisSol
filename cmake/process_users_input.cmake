...
if (NOT ${DEVICE_BACKEND} STREQUAL "none")
    ...
    if (${DEVICE_CODEGEN} STREQUAL "auto")
        ...
        if ((${DEVICE_BACKEND} STREQUAL "oneapi" AND ${DEVICE_VENDOR} STREQUAL "intel" AND ${DEVICE_CODEGEN} STREQUAL "auto"))
            find_package(tinytc 0.3.1 QUIET shared)
            find_package(tinytc_sycl 0.3.1 QUIET shared)
