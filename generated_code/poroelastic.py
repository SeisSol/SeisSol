...
class PoroelasticADERDG(LinearADERDG):
  ...
  def addTime(self, generator, targets):
    ...
    spaceTimePredictorRhs = OptionalDimTensor('spaceTimePredictorRhs', self.Q.optName(), self.Q.optSize(), self.Q.optPos(), stpShape, alignStride=True)
    spaceTimePredictor = OptionalDimTensor('spaceTimePredictor', self.Q.optName(), self.Q.optSize(), self.Q.optPos(), stpShape, alignStride=True)
    testRhs = OptionalDimTensor('testRhs', self.Q.optName(), self.Q.optSize(), self.Q.optPos(), stpShape, alignStride=True)
    testLhs = OptionalDimTensor('testLhs', self.Q.optName(), self.Q.optSize(), self.Q.optPos(), stpShape, alignStride=True)
    ...
    def selectQuantity(quantityNumber):
      ...
      return Tensor('selectQuantity({})'.format(quantityNumber), selectSpp.shape, spp = selectSpp)
    ...
    def selectQuantityG(quantityNumber):
      ...
      return Tensor('selectQuantityG({})'.format(quantityNumber), selectSpp.shape, spp = selectSpp)
