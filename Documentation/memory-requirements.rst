...
When the equivalent distribution of memory among nodes is necessart the user can choose the *exponential-balanced* node weight cost model for the initial partitioning of the workload.
