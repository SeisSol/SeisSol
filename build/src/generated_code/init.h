...
namespace seissol {
  namespace init {
    ...
    struct QInterpolatedMinus : tensor::QInterpolatedMinus {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {52, 9};
    ...
    struct QInterpolatedPlus : tensor::QInterpolatedPlus {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {52, 9};
    ...
    struct V2nTo2JacobiQuad : tensor::V2nTo2JacobiQuad {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {49, 21};
      static double const Values[];

      struct view {
        typedef ::yateto::DenseTensorView<2,double,unsigned> type;
        static inline type create(double* values) {
          return ::yateto::DenseTensorView<2,double,unsigned>(values, {49, 21}, {0, 0}, {49, 21});
        }
      };
    };
    ...
    struct frictionalEnergy : tensor::frictionalEnergy {

      struct view {
        typedef ::yateto::DenseTensorView<0,double,unsigned> type;
        static inline type create(double* values) {
          return ::yateto::DenseTensorView<0,double,unsigned>(values, {}, {}, {});
        }
      };
    };
    ...
    struct rotatedFaceDisplacementAtQuadratureNodes : tensor::rotatedFaceDisplacementAtQuadratureNodes {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {52, 3};

      struct view {
        typedef ::yateto::DenseTensorView<2,double,unsigned> type;
        static inline type create(double* values) {
          return ::yateto::DenseTensorView<2,double,unsigned>(values, {49, 3}, {0, 0}, {52, 3});
        }
      };
    };
    ...
    struct slipInterpolated : tensor::slipInterpolated {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {49, 3};

      struct view {
        typedef ::yateto::DenseTensorView<2,double,unsigned> type;
        static inline type create(double* values) {
          return ::yateto::DenseTensorView<2,double,unsigned>(values, {49, 3}, {0, 0}, {49, 3});
        }
      };
    };
    struct slipRateInterpolated : tensor::slipRateInterpolated {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {49, 3};
    ...
    struct spaceWeights : tensor::spaceWeights {
      constexpr static unsigned const Start[] = {0};
      constexpr static unsigned const Stop[] = {49};

      struct view {
        typedef ::yateto::DenseTensorView<1,double,unsigned> type;
        static inline type create(double* values) {
          return ::yateto::DenseTensorView<1,double,unsigned>(values, {49}, {0}, {49});
        }
      };
    };
    struct squaredNormSlipRateInterpolated : tensor::squaredNormSlipRateInterpolated {
      constexpr static unsigned const Start[] = {0};
      constexpr static unsigned const Stop[] = {49};
    ...
    struct tractionInterpolated : tensor::tractionInterpolated {
      constexpr static unsigned const Start[] = {0, 0};
      constexpr static unsigned const Stop[] = {49, 3};
    ...
    struct tractionMinusMatrix : tensor::tractionMinusMatrix {
      constexpr static unsigned const RowInd[] = {0, 3, 5};
      constexpr static unsigned const ColPtr[] = {0, 1, 2, 3};
    ...
    struct tractionPlusMatrix : tensor::tractionPlusMatrix {
      constexpr static unsigned const RowInd[] = {0, 3, 5};
      constexpr static unsigned const ColPtr[] = {0, 1, 2, 3};
