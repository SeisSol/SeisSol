...
namespace seissol {
  ...
  namespace kernel {
    struct rotateFaceDisplacementsAndEvaluateAtQuadratureNodes {
      constexpr static unsigned long const NonZeroFlops = 6342;
      constexpr static unsigned long const HardwareFlops = 6606;
      constexpr static unsigned long const TmpMemRequiredInBytes = 576;
      constexpr static unsigned long const TmpMaxMemRequiredInBytes = 576;

      double const* V2nTo2JacobiQuad{};
      double const* displacementRotationMatrix{};
      double const* rotatedFaceDisplacement{};
      double* rotatedFaceDisplacementAtQuadratureNodes{};
  ...
  namespace dynamicRupture {
    namespace kernel {
      struct computeSlipRateInterpolated {
        constexpr static unsigned long const NonZeroFlops = 441;
        constexpr static unsigned long const HardwareFlops = 735;
        constexpr static unsigned long const TmpMemRequiredInBytes = 0;
        constexpr static unsigned long const TmpMaxMemRequiredInBytes = 0;

        double const* QInterpolatedMinus{};
        double const* QInterpolatedPlus{};
        double const* selectVelocity{};
        double* slipRateInterpolated{};
  ...
  namespace dynamicRupture {
    namespace kernel {
      struct computeTractionInterpolated {
        constexpr static unsigned long const NonZeroFlops = 441;
        constexpr static unsigned long const HardwareFlops = 588;
        constexpr static unsigned long const TmpMemRequiredInBytes = 0;
        constexpr static unsigned long const TmpMaxMemRequiredInBytes = 0;

        double const* QInterpolatedMinus{};
        double const* QInterpolatedPlus{};
        double* tractionInterpolated{};
        double const* tractionMinusMatrix{};
        double const* tractionPlusMatrix{};
  ...
  namespace dynamicRupture {
    namespace kernel {
      struct accumulateSlipInterpolated {
        constexpr static unsigned long const NonZeroFlops = 294;
        constexpr static unsigned long const HardwareFlops = 294;
        constexpr static unsigned long const TmpMemRequiredInBytes = 0;
        constexpr static unsigned long const TmpMaxMemRequiredInBytes = 0;

        double timeWeight = std::numeric_limits<double>::signaling_NaN();
        double* slipInterpolated{};
        double const* slipRateInterpolated{};
  ...
  namespace dynamicRupture {
    namespace kernel {
      struct computeSquaredNormSlipRateInterpolated {
        constexpr static unsigned long const NonZeroFlops = 245;
        constexpr static unsigned long const HardwareFlops = 294;
        constexpr static unsigned long const TmpMemRequiredInBytes = 0;
        constexpr static unsigned long const TmpMaxMemRequiredInBytes = 0;

        double const* slipRateInterpolated{};
        double* squaredNormSlipRateInterpolated{};
  ...
  namespace dynamicRupture {
    namespace kernel {
      struct accumulateFrictionalEnergy {
        constexpr static unsigned long const NonZeroFlops = 344;
        constexpr static unsigned long const HardwareFlops = 441;
        constexpr static unsigned long const TmpMemRequiredInBytes = 392;
        constexpr static unsigned long const TmpMaxMemRequiredInBytes = 392;

        double timeWeight = std::numeric_limits<double>::signaling_NaN();
        double* frictionalEnergy{};
        double const* slipRateInterpolated{};
        double const* spaceWeights{};
        double const* tractionInterpolated{};
  ...
  namespace kernel {
    struct projectDerivativeToNodalBoundaryRotated {
      constexpr static unsigned long const NonZeroFlops[] = {22770, 15426, 9999, 4941, 1881, 342, 22500, 15246, 9891, 4887, 1863, 342, 20178, 13932, 9243, 4635, 1809, 342, 20232, 13968, 9261, 4635, 1809, 342};
      constexpr static unsigned long const HardwareFlops[] = {28080, 19008, 11880, 6264, 2376, 1080, 28080, 19008, 11880, 6264, 2376, 1080, 28080, 19008, 11880, 6264, 2376, 1080, 28080, 19008, 11880, 6264, 2376, 1080};
      constexpr static unsigned long const TmpMemRequiredInBytes[] = {1728, 1728, 1440, 864, 288, 288, 1728, 1728, 1440, 864, 288, 288, 1728, 1728, 1440, 864, 288, 288, 1728, 1728, 1440, 864, 288, 288};
      constexpr static unsigned long const TmpMaxMemRequiredInBytes = 1728;
      ...
      void execute22();
      void execute23();
      using member_function_ptr = void (projectDerivativeToNodalBoundaryRotated::*)();
      constexpr static member_function_ptr ExecutePtrs[] = {&projectDerivativeToNodalBoundaryRotated::execute0, &projectDerivativeToNodalBoundaryRotated::execute1, &projectDerivativeToNodalBoundaryRotated::execute2, &projectDerivativeToNodalBoundaryRotated::execute3, &projectDerivativeToNodalBoundaryRotated::execute4, &projectDerivativeToNodalBoundaryRotated::execute5, &projectDerivativeToNodalBoundaryRotated::execute6, &projectDerivativeToNodalBoundaryRotated::execute7, &projectDerivativeToNodalBoundaryRotated::execute8, &projectDerivativeToNodalBoundaryRotated::execute9, &projectDerivativeToNodalBoundaryRotated::execute10, &projectDerivativeToNodalBoundaryRotated::execute11, &projectDerivativeToNodalBoundaryRotated::execute12, &projectDerivativeToNodalBoundaryRotated::execute13, &projectDerivativeToNodalBoundaryRotated::execute14, &projectDerivativeToNodalBoundaryRotated::execute15, &projectDerivativeToNodalBoundaryRotated::execute16, &projectDerivativeToNodalBoundaryRotated::execute17, &projectDerivativeToNodalBoundaryRotated::execute18, &projectDerivativeToNodalBoundaryRotated::execute19, &projectDerivativeToNodalBoundaryRotated::execute20, &projectDerivativeToNodalBoundaryRotated::execute21, &projectDerivativeToNodalBoundaryRotated::execute22, &projectDerivativeToNodalBoundaryRotated::execute23};
      constexpr static member_function_ptr findExecute(unsigned i0, unsigned i1) {
        return ExecutePtrs[1*i0 + 6*i1];
      }
