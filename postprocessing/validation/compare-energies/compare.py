...
relevant_quantities = ["elastic_energy", "elastic_kinetic_energy", "total_frictional_work", "static_frictional_work", "seismic_moment"]
...
relative_difference_smaller_eps = (relative_difference.iloc[1:,:] < args.epsilon).values
