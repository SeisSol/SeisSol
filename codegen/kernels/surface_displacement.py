...
def addKernels(generator, aderdg, include_tensors, targets):
    ...
    addVelocity = (
        ...
        <= faceDisplacement["kp"]
        + aderdg.db.V3mTo2nFace[f][aderdg.t("kl")] * aderdg.I["lq"]
        # Out of what crossed the face, which is what this reads: the same
        # selection as out of the state wherever the two coincide.
        * aderdg.selectVelocityTransported["qp"]
    )
