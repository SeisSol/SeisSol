...
// newly added:
#define MPI_C_BOOL         (3 << 20 | 1 << 8 | (int)sizeof(char))
#define MPI_CXX_BOOL         (3 << 20 | 1 << 8 | (int)sizeof(char))
#define MPI_WCHAR          (4 << 20 | 1 << 8 | (int)sizeof(short))

#define MPI_UINT8_T        (5 << 20 | 1 << 8 | (int)sizeof(uint8_t))
#define MPI_UINT16_T       (5 << 20 | 1 << 8 | (int)sizeof(uint16_t))
#define MPI_UINT32_T       (5 << 20 | 1 << 8 | (int)sizeof(uint32_t))
#define MPI_UINT64_T       (5 << 20 | 1 << 8 | (int)sizeof(uint64_t))
...
#define MPI_File_write(mpi_fh, buf, count, datatype, status) (MPIUNI_ARG(mpi_fh), MPIUNI_ARG(buf), MPIUNI_ARG(count), MPIUNI_ARG(datatype), MPIUNI_ARG(status), MPIUni_Abort(MPI_COMM_WORLD, 0))

#define MPI_File_read(mpi_fh, buf, count, datatype, status) (MPIUNI_ARG(mpi_fh), MPIUNI_ARG(buf), MPIUNI_ARG(count), MPIUNI_ARG(datatype), MPIUNI_ARG(status), MPIUni_Abort(MPI_COMM_WORLD, 0))
