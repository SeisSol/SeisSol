...
fault and a branch fault intersecting at an angle of 30 degrees (:numref:`figtpv24`). The earthquake rupture is artificially nucleated in a
...
There are two faults, called the main fault and the branch fault (:numref:`figtpv24`). The two faults are vertical, planar, strike-slip faults.
...
:numref:`figtpv24mesh` shows the fault model generated in Gmsh. The mesh
...
m. :numref:`tabletpv24` summarizes the initial stress conditions in
TPV24.
...
The friction parameters are listed in :numref:`tabletpv24fric`.

.. _tabletpv24fric:
.. table::
   Table of LSR parameters on the fault in TPV24.
...
as well as the rest main fault. The fault slip rate is shown in :numref:`tpv24result1`.
