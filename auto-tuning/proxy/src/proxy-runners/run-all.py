...
parser.add_argument(
    "-c", "--cells", default=50000, type=int, help="num cells in a time cluster"
)
parser.add_argument(
    "-t", "--timesteps", default=30, type=int, help="num time steps/repeats"
)
parser.add_argument(
    "--output_type", choices=plotting_options, default="csv", help="format to save data"
)
parser.add_argument(
    "-o", "--output_dir", default=".", type=str, help="relative output directory"
)
