...
#ifndef SEISSOL_SRC_SOLVER_TIMESTEPPING_HALO_STREAM_SHMEMEXCHANGESCHEDULER_H_
#define SEISSOL_SRC_SOLVER_TIMESTEPPING_HALO_STREAM_SHMEMEXCHANGESCHEDULER_H_
