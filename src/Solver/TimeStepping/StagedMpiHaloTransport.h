...
#ifndef SEISSOL_SRC_SOLVER_TIMESTEPPING_STAGEDMPIHALOTRANSPORT_H_
#define SEISSOL_SRC_SOLVER_TIMESTEPPING_STAGEDMPIHALOTRANSPORT_H_
...
#endif // SEISSOL_SRC_SOLVER_TIMESTEPPING_STAGEDMPIHALOTRANSPORT_H_
