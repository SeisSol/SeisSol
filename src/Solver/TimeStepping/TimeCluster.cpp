...
seissol::time_stepping::TimeCluster::TimeCluster(
    ...
    : AbstractTimeCluster(
      ...
      layerType(layerIdentifier.halo), printProgress(printProgress), clusterId(clusterId),
...
initializer::LayerIdentifier TimeCluster::getIdentifier() const { return layerIdentifier; }
