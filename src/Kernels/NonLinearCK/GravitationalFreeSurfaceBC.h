...
#ifndef SEISSOL_SRC_KERNELS_NONLINEARCK_GRAVITATIONALFREESURFACEBC_H_
#define SEISSOL_SRC_KERNELS_NONLINEARCK_GRAVITATIONALFREESURFACEBC_H_
...
#endif // SEISSOL_SRC_KERNELS_NONLINEARCK_GRAVITATIONALFREESURFACEBC_H_
