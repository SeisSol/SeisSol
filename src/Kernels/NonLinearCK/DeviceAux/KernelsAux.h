...
#ifndef SEISSOL_SRC_KERNELS_NONLINEARCK_DEVICEAUX_KERNELSAUX_H_
#define SEISSOL_SRC_KERNELS_NONLINEARCK_DEVICEAUX_KERNELSAUX_H_
...
#endif // SEISSOL_SRC_KERNELS_NONLINEARCK_DEVICEAUX_KERNELSAUX_H_
