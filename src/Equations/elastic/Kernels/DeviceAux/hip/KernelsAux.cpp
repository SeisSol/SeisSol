...
for (int j = 0; j < Quantities; ++j) {
    ...
    temp[1 * Quantities * 3 + (j + Quantities * 0)] = 6.f * column[4] + 2.f * column[11] + 2.f * column[14] + 2.8571428571428571429f * column[20] + .85714285714285714286f * column[22] + .85714285714285714286f * column[26] + .85714285714285714286f * column[29];
    temp[2 * Quantities * 3 + (j + Quantities * 0)] = 3.3333333333333333333f * column[5] + -.66666666666666666667f * column[10] + 2.6666666666666666667f * column[12] + 1.1111111111111111111f * column[15] + .57142857142857142857f * column[21] + 2.f * column[23] + -.28571428571428571429f * column[25] + 1.1428571428571428571f * column[27] + .47619047619047619048f * column[30];
    temp[3 * Quantities * 3 + (j + Quantities * 0)] = -.33333333333333333333f * column[5] + 3.f * column[7] + -.33333333333333333333f * column[10] + -.33333333333333333333f * column[12] + 1.2222222222222222222f * column[15] + 2.3333333333333333333f * column[17] + -.28571428571428571429f * column[21] + -.28571428571428571429f * column[23] + .57142857142857142857f * column[25] + .57142857142857142857f * column[27] + 1.2380952380952380952f * column[30] + 1.7142857142857142857f * column[32];
    temp[4 * Quantities * 3 + (j + Quantities * 0)] = 10.f * column[10] + 2.5000000000000000000f * column[21] + 2.5000000000000000000f * column[25];
    temp[5 * Quantities * 3 + (j + Quantities * 0)] = 8.4000000000000000000f * column[11] + -1.5000000000000000000f * column[20] + 4.8000000000000000000f * column[22] + 2.1000000000000000000f * column[26];
    temp[6 * Quantities * 3 + (j + Quantities * 0)] = .20000000000000000000f * column[10] + 4.2000000000000000000f * column[12] + -1.3000000000000000000f * column[21] + 4.2000000000000000000f * column[23] + .50000000000000000000e-1f * column[25] + 1.0500000000000000000f * column[27];
    temp[7 * Quantities * 3 + (j + Quantities * 0)] = -.40000000000000000000f * column[11] + 8.f * column[14] + -1.f * column[20] + -.30000000000000000000f * column[22] + 2.4000000000000000000f * column[26] + 4.5000000000000000000f * column[29];
    temp[8 * Quantities * 3 + (j + Quantities * 0)] = .13333333333333333333f * column[10] + -.53333333333333333333f * column[12] + 4.4444444444444444444f * column[15] + -.20000000000000000000f * column[21] + -.70000000000000000000f * column[23] + -.80000000000000000000f * column[25] + 3.2000000000000000000f * column[27] + 2.5000000000000000000f * column[30];
    temp[9 * Quantities * 3 + (j + Quantities * 0)] = .66666666666666666667e-1f * column[10] + .66666666666666666667e-1f * column[12] + -.71111111111111111111f * column[15] + 3.7333333333333333333f * column[17] + .10000000000000000000f * column[21] + .10000000000000000000f * column[23] + -.65000000000000000000f * column[25] + -.65000000000000000000f * column[27] + 1.1000000000000000000f * column[30] + 3.6000000000000000000f * column[32];
    temp[10 * Quantities * 3 + (j + Quantities * 0)] = 14.f * column[20];
    temp[11 * Quantities * 3 + (j + Quantities * 0)] = 12.857142857142857143f * column[21];
    temp[12 * Quantities * 3 + (j + Quantities * 0)] = .28571428571428571429f * column[20] + 10.285714285714285714f * column[22];
    temp[13 * Quantities * 3 + (j + Quantities * 0)] = .51428571428571428571f * column[21] + 4.8000000000000000000f * column[23];
    temp[14 * Quantities * 3 + (j + Quantities * 0)] = -.35714285714285714286f * column[21] + 12.500000000000000000f * column[25];
    temp[15 * Quantities * 3 + (j + Quantities * 0)] = .21428571428571428571f * column[20] + -.68571428571428571429f * column[22] + 10.500000000000000000f * column[26];
    temp[16 * Quantities * 3 + (j + Quantities * 0)] = .18571428571428571429f * column[21] + -.60000000000000000000f * column[23] + .25000000000000000000f * column[25] + 5.2500000000000000000f * column[27];
    temp[17 * Quantities * 3 + (j + Quantities * 0)] = .14285714285714285714f * column[20] + .42857142857142857143e-1f * column[22] + -.85714285714285714286f * column[26] + 9.6428571428571428571f * column[29];
    temp[18 * Quantities * 3 + (j + Quantities * 0)] = .28571428571428571429e-1f * column[21] + .10000000000000000000f * column[23] + .28571428571428571429f * column[25] + -1.1428571428571428571f * column[27] + 5.3571428571428571429f * column[30];
    temp[19 * Quantities * 3 + (j + Quantities * 0)] = -.14285714285714285714e-1f * column[21] + -.14285714285714285714e-1f * column[23] + .17857142857142857143f * column[25] + .17857142857142857143f * column[27] + -1.0714285714285714286f * column[30] + 4.2857142857142857143f * column[32];
    temp[0 * Quantities * 3 + (j + Quantities * 1)] = 1.f * column[1] + 3.f * column[2] + .50000000000000000000f * column[4] + .50000000000000000000f * column[5] + -1.f * column[6] + .50000000000000000000f * column[7] + 1.5000000000000000000f * column[8] + .30000000000000000000f * column[10] + .30000000000000000000f * column[11] + .30000000000000000000f * column[12] + 1.5000000000000000000f * column[13] + .30000000000000000000f * column[14] + .30000000000000000000f * column[15] + -.60000000000000000000f * column[16] + .30000000000000000000f * column[17] + .90000000000000000000f * column[18] + .20000000000000000000f * column[20] + .20000000000000000000f * column[21] + .20000000000000000000f * column[22] + .20000000000000000000f * column[23] + -.80000000000000000000f * column[24] + .20000000000000000000f * column[25] + .20000000000000000000f * column[26] + .20000000000000000000f * column[27] + 1.f * column[28] + .20000000000000000000f * column[29] + .20000000000000000000f * column[30] + -.40000000000000000000f * column[31] + .20000000000000000000f * column[32] + .60000000000000000000f * column[33];
    temp[1 * Quantities * 3 + (j + Quantities * 1)] = 3.f * column[4] + 5.f * column[5] + 2.f * column[10] + 1.f * column[11] + -3.f * column[12] + 1.f * column[14] + 1.6666666666666666667f * column[15] + 1.4285714285714285714f * column[20] + .85714285714285714286f * column[21] + .42857142857142857143f * column[22] + 3.f * column[23] + .85714285714285714286f * column[25] + .42857142857142857143f * column[26] + -1.2857142857142857143f * column[27] + .42857142857142857143f * column[29] + .71428571428571428571f * column[30];
    ...
    temp[4 * Quantities * 3 + (j + Quantities * 1)] = 5.f * column[10] + 7.f * column[11] + 3.7500000000000000000f * column[20] + 1.2500000000000000000f * column[21] + -5.f * column[22] + 1.2500000000000000000f * column[25] + 1.7500000000000000000f * column[26];
    ...
    temp[10 * Quantities * 3 + (j + Quantities * 1)] = 7.f * column[20] + 9.f * column[21];
    temp[11 * Quantities * 3 + (j + Quantities * 1)] = -.71428571428571428571f * column[20] + 6.4285714285714285714f * column[21] + 10.285714285714285714f * column[22];
    temp[12 * Quantities * 3 + (j + Quantities * 1)] = .14285714285714285714f * column[20] + -1.2857142857142857143f * column[21] + 5.1428571428571428571f * column[22] + 12.f * column[23];
    temp[13 * Quantities * 3 + (j + Quantities * 1)] = -.28571428571428571429e-1f * column[20] + .25714285714285714286f * column[21] + -1.0285714285714285714f * column[22] + 2.4000000000000000000f * column[23] + 14.400000000000000000f * column[24];
    temp[14 * Quantities * 3 + (j + Quantities * 1)] = -.53571428571428571429f * column[20] + -.17857142857142857143f * column[21] + .71428571428571428571f * column[22] + 6.2500000000000000000f * column[25] + 8.7500000000000000000f * column[26];
    temp[15 * Quantities * 3 + (j + Quantities * 1)] = .10714285714285714286f * column[20] + -.36428571428571428571f * column[21] + -.34285714285714285714f * column[22] + .60000000000000000000f * column[23] + -.75000000000000000000f * column[25] + 5.2500000000000000000f * column[26] + 10.500000000000000000f * column[27];
    ...
    temp[4 * Quantities * 3 + (j + Quantities * 2)] = 5.f * column[10] + 1.f * column[11] + 8.f * column[14] + 3.7500000000000000000f * column[20] + 1.2500000000000000000f * column[21] + .25000000000000000000f * column[22] + 1.2500000000000000000f * column[25] + .25000000000000000000f * column[26] + -6.7500000000000000000f * column[29];
    ...
    temp[10 * Quantities * 3 + (j + Quantities * 2)] = 7.f * column[20] + 1.f * column[21] + 10.f * column[25];
    temp[11 * Quantities * 3 + (j + Quantities * 2)] = -.71428571428571428571f * column[20] + 6.4285714285714285714f * column[21] + 2.2857142857142857143f * column[22] + 10.f * column[26];
    temp[12 * Quantities * 3 + (j + Quantities * 2)] = .14285714285714285714f * column[20] + -1.2857142857142857143f * column[21] + 5.1428571428571428571f * column[22] + 4.f * column[23] + 10.f * column[27];
    temp[13 * Quantities * 3 + (j + Quantities * 2)] = -.28571428571428571429e-1f * column[20] + .25714285714285714286f * column[21] + -1.0285714285714285714f * column[22] + 2.4000000000000000000f * column[23] + 6.4000000000000000000f * column[24] + 10.f * column[28];
    temp[14 * Quantities * 3 + (j + Quantities * 2)] = -.53571428571428571429f * column[20] + -.17857142857142857143f * column[21] + -.35714285714285714286e-1f * column[22] + 6.2500000000000000000f * column[25] + 1.2500000000000000000f * column[26] + 11.250000000000000000f * column[29];
    temp[15 * Quantities * 3 + (j + Quantities * 2)] = .10714285714285714286f * column[20] + -.36428571428571428571f * column[21] + -.34285714285714285714f * column[22] + -.15000000000000000000f * column[23] + -.75000000000000000000f * column[25] + 5.2500000000000000000f * column[26] + 3.f * column[27] + 11.250000000000000000f * column[30];
...
for (int j = 0; j < Quantities; ++j) {
    ...
    temp[0 * Quantities * 3 + (j + Quantities * 0)] = 2.f * column[1] + 1.f * column[5] + 1.f * column[7] + .60000000000000000000f * column[10] + .60000000000000000000f * column[12] + .60000000000000000000f * column[15] + .60000000000000000000f * column[17];
    temp[1 * Quantities * 3 + (j + Quantities * 0)] = 6.f * column[4] + 2.f * column[11] + 2.f * column[14];
    temp[2 * Quantities * 3 + (j + Quantities * 0)] = 3.3333333333333333333f * column[5] + -.66666666666666666667f * column[10] + 2.6666666666666666667f * column[12] + 1.1111111111111111111f * column[15];
    temp[3 * Quantities * 3 + (j + Quantities * 0)] = -.33333333333333333333f * column[5] + 3.f * column[7] + -.33333333333333333333f * column[10] + -.33333333333333333333f * column[12] + 1.2222222222222222222f * column[15] + 2.3333333333333333333f * column[17];
    temp[4 * Quantities * 3 + (j + Quantities * 0)] = 10.f * column[10];
    temp[5 * Quantities * 3 + (j + Quantities * 0)] = 8.4000000000000000000f * column[11];
    temp[6 * Quantities * 3 + (j + Quantities * 0)] = .20000000000000000000f * column[10] + 4.2000000000000000000f * column[12];
    temp[7 * Quantities * 3 + (j + Quantities * 0)] = -.40000000000000000000f * column[11] + 8.f * column[14];
    temp[8 * Quantities * 3 + (j + Quantities * 0)] = .13333333333333333333f * column[10] + -.53333333333333333333f * column[12] + 4.4444444444444444444f * column[15];
    temp[9 * Quantities * 3 + (j + Quantities * 0)] = .66666666666666666667e-1f * column[10] + .66666666666666666667e-1f * column[12] + -.71111111111111111111f * column[15] + 3.7333333333333333333f * column[17];
    temp[0 * Quantities * 3 + (j + Quantities * 1)] = 1.f * column[1] + 3.f * column[2] + .50000000000000000000f * column[4] + .50000000000000000000f * column[5] + -1.f * column[6] + .50000000000000000000f * column[7] + 1.5000000000000000000f * column[8] + .30000000000000000000f * column[10] + .30000000000000000000f * column[11] + .30000000000000000000f * column[12] + 1.5000000000000000000f * column[13] + .30000000000000000000f * column[14] + .30000000000000000000f * column[15] + -.60000000000000000000f * column[16] + .30000000000000000000f * column[17] + .90000000000000000000f * column[18];
    temp[1 * Quantities * 3 + (j + Quantities * 1)] = 3.f * column[4] + 5.f * column[5] + 2.f * column[10] + 1.f * column[11] + -3.f * column[12] + 1.f * column[14] + 1.6666666666666666667f * column[15];
    ...
    temp[4 * Quantities * 3 + (j + Quantities * 1)] = 5.f * column[10] + 7.f * column[11];
    temp[5 * Quantities * 3 + (j + Quantities * 1)] = -.60000000000000000000f * column[10] + 4.2000000000000000000f * column[11] + 8.4000000000000000000f * column[12];
    temp[6 * Quantities * 3 + (j + Quantities * 1)] = .10000000000000000000f * column[10] + -.70000000000000000000f * column[11] + 2.1000000000000000000f * column[12] + 10.500000000000000000f * column[13];
    temp[7 * Quantities * 3 + (j + Quantities * 1)] = -.40000000000000000000f * column[10] + -.20000000000000000000f * column[11] + .60000000000000000000f * column[12] + 4.f * column[14] + 6.6666666666666666667f * column[15];
    temp[8 * Quantities * 3 + (j + Quantities * 1)] = .66666666666666666667e-1f * column[10] + -.13333333333333333333f * column[11] + -.26666666666666666667f * column[12] + .33333333333333333333f * column[13] + -.44444444444444444444f * column[14] + 2.2222222222222222222f * column[15] + 8.8888888888888888889f * column[16];
    temp[9 * Quantities * 3 + (j + Quantities * 1)] = .33333333333333333333e-1f * column[10] + .33333333333333333333e-1f * column[11] + .33333333333333333333e-1f * column[12] + .16666666666666666667f * column[13] + -.35555555555555555556f * column[14] + -.35555555555555555556f * column[15] + .71111111111111111111f * column[16] + 1.8666666666666666667f * column[17] + 5.6000000000000000000f * column[18];
    temp[0 * Quantities * 3 + (j + Quantities * 2)] = 1.f * column[1] + 1.f * column[2] + 4.f * column[3] + .50000000000000000000f * column[4] + .50000000000000000000f * column[5] + .50000000000000000000f * column[6] + .50000000000000000000f * column[7] + .50000000000000000000f * column[8] + -2.5000000000000000000f * column[9] + .30000000000000000000f * column[10] + .30000000000000000000f * column[11] + .30000000000000000000f * column[12] + .30000000000000000000f * column[13] + .30000000000000000000f * column[14] + .30000000000000000000f * column[15] + .30000000000000000000f * column[16] + .30000000000000000000f * column[17] + .30000000000000000000f * column[18] + 3.3000000000000000000f * column[19];
    temp[1 * Quantities * 3 + (j + Quantities * 2)] = 3.f * column[4] + 1.f * column[5] + 6.f * column[7] + 2.f * column[10] + 1.f * column[11] + .33333333333333333333f * column[12] + 1.f * column[14] + .33333333333333333333f * column[15] + -4.6666666666666666667f * column[17];
    ...
    temp[4 * Quantities * 3 + (j + Quantities * 2)] = 5.f * column[10] + 1.f * column[11] + 8.f * column[14];
    temp[5 * Quantities * 3 + (j + Quantities * 2)] = -.60000000000000000000f * column[10] + 4.2000000000000000000f * column[11] + 2.4000000000000000000f * column[12] + 8.f * column[15];
    temp[6 * Quantities * 3 + (j + Quantities * 2)] = .10000000000000000000f * column[10] + -.70000000000000000000f * column[11] + 2.1000000000000000000f * column[12] + 4.5000000000000000000f * column[13] + 8.f * column[16];
    temp[7 * Quantities * 3 + (j + Quantities * 2)] = -.40000000000000000000f * column[10] + -.20000000000000000000f * column[11] + -.66666666666666666667e-1f * column[12] + 4.f * column[14] + 1.3333333333333333333f * column[15] + 9.3333333333333333333f * column[17];
    temp[8 * Quantities * 3 + (j + Quantities * 2)] = .66666666666666666667e-1f * column[10] + -.13333333333333333333f * column[11] + -.26666666666666666667f * column[12] + -.33333333333333333333f * column[13] + -.44444444444444444444f * column[14] + 2.2222222222222222222f * column[15] + 3.5555555555555555556f * column[16] + 9.3333333333333333333f * column[18];
...
__global__ __launch_bounds__(AderMultiple*Blocksize) void dgkernelFull(std::size_t blockCount, real scale, real* __restrict__ I, const real* __restrict__ Q, real* __restrict__ dQ6, real* __restrict__ dQ5, real* __restrict__ dQ4, real* __restrict__ dQ3, real* __restrict__ dQ2, real* __restrict__ dQ1, const real* __restrict__ stardata, const real* __restrict__ coordinates, real* __restrict__ temp) {
    if (threadIdx.y + AderMultiple * blockIdx.x < blockCount) {
        ...
        dgkernel56(tempreg2, Q);
        coeff *= scale / 2;
        dgkernelPart2<35, 56>(coeff, dQ5, I,  tempreg2, coordinates, lambda, mu, rhoD);
        dgkernel35(tempreg2, dQ5);
        coeff *= scale / 3;
        dgkernelPart2<20, 56>(coeff, dQ4, I,  tempreg2, coordinates, lambda, mu, rhoD);
        dgkernel20(tempreg2, dQ4);
        coeff *= scale / 4;
        dgkernelPart2<10, 56>(coeff, dQ3, I,  tempreg2, coordinates, lambda, mu, rhoD);
        dgkernel10(tempreg, dQ3);
        coeff *= scale / 5;
