...
#ifndef SEISSOL_SRC_EQUATIONS_VISCOELASTIC2_MODEL_IMPEDANCE_H_
#define SEISSOL_SRC_EQUATIONS_VISCOELASTIC2_MODEL_IMPEDANCE_H_
 ...
 *
 * Shared by USE_VISCOELASTIC and USE_VISCOELASTIC2, like the material itself.
 */
template <std::size_t Mechanisms>
struct ImpedanceCompute<ViscoElasticMaterialParametrized<Mechanisms>>
    : public ImpedanceCompute<ElasticMaterial> {};

} // namespace seissol::model

#endif // SEISSOL_SRC_EQUATIONS_VISCOELASTIC2_MODEL_IMPEDANCE_H_
