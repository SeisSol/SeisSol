  ...
  */
  ...
  case 0:
    ...
    o_M(9, 6) = (i_material.gammaR * std::sqrt(I2) +
                ...
                i_material.rho;
    o_M(9, 7) = (0 + i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epsxy_alpha) /
                i_material.rho;
    o_M(9, 8) = (0 + i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epszx_alpha) /
                i_material.rho;
    break;
  ...
  case 1:
    ...
    o_M(9, 6) = (0 + i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epsxy_alpha) /
                i_material.rho;
    o_M(9, 7) = (i_material.gammaR * std::sqrt(I2) +
                 i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epsyy_alpha) /
                i_material.rho;
    o_M(9, 8) = (0 + i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epsyz_alpha) /
                i_material.rho;
    break;
  ...
  case 2:
    ...
    o_M(9, 6) = (0 + i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epszx_alpha) /
                i_material.rho;
    o_M(9, 7) = (0 + i_material.gammaR * (xi + 2.0 * i_material.xi0) * i_material.epsyz_alpha) /
                i_material.rho;
...
inline void getTransposedGodunovState(DamagedElasticMaterial const& local,
  ...
  */
  ...
  real I2 = local.epsxx_alpha * local.epsxx_alpha + local.epsyy_alpha * local.epsyy_alpha +
            local.epszz_alpha * local.epszz_alpha + 2 * local.epsxy_alpha * local.epsxy_alpha +
            2 * local.epsyz_alpha * local.epsyz_alpha + 2 * local.epszx_alpha * local.epszx_alpha;
...
void getTransposedFreeSurfaceGodunovState(MaterialType materialtype,
  ...
  if (materialtype != MaterialType::damaged) {
    logError() << "This is only used for damaged elastic materials. You should never end up here.";
  }
  ...
  using Matrix73 = Eigen::Matrix<double, 7, 3>;
  QgodLocal.setZero();
  ...
  Matrix73 R21 = R(velocity_indices, {0, 1, 2});
  Matrix73 S = (-(R21 * R11.inverse())).eval();
