        ...
        switch (i_dim)
          {
            case 0:
              ...
              o_M(9,6) = i_material.sigmaxx_alpha / i_material.rho;
              o_M(9,7) = i_material.sigmaxy_alpha / i_material.rho;
              o_M(9,8) = i_material.sigmaxz_alpha / i_material.rho;
              break;
            ...
            case 1:
              ...
              o_M(9,6) = i_material.sigmayx_alpha / i_material.rho;
              o_M(9,7) = i_material.sigmayy_alpha / i_material.rho;
              o_M(9,8) = i_material.sigmayz_alpha / i_material.rho;
              break;
            ...
            case 2:
              ...
              o_M(9,6) = i_material.sigmazx_alpha / i_material.rho;
              o_M(9,7) = i_material.sigmazy_alpha / i_material.rho;
              o_M(9,8) = i_material.sigmazz_alpha / i_material.rho;
              break;
        ...
        */
        if (testIfAcoustic(local.mu)) {
         ...
         if (testIfAcoustic(neighbor.mu)) {
          ...
          R(0,9) = local.sigmaxx_alpha/
                      ((local.lambda+2*local.mu)/local.rho);
          R(3,9) = local.sigmaxy_alpha/(2*local.mu/local.rho);
          R(5,9) = local.sigmaxz_alpha/(2*local.mu/local.rho);
          R(9,9) = local.rho;
         #endif
