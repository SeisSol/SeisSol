...
class ReceiverOutput {
  ...
  struct LocalInfo {
    ...
    real faceAlignedValuesPlus[tensor::QAtPoint::Shape[seissol::multisim::BasisFunctionDimension]]{};
    real faceAlignedValuesMinus[tensor::QAtPoint::Shape[seissol::multisim::BasisFunctionDimension]]{};
