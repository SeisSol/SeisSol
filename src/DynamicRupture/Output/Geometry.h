...
struct ReceiverPoint {
  ...
  int faultTag{-1};
  int simIndex{0};
  int gpIndexFused{-1}; // Index of the nearest gaussian point considering fused simulations
  ...
  int internalGpIndexFused{-1}; // Index of the nearest internal gaussian point considering fused simulations
