...
namespace seissol::dr::initializers {
  class RateAndStateFL103Initializer;       //rate and state with time and space dependent nucleation parameter
 ...
 */
class seissol::dr::initializers::RateAndStateFL103Initializer : public seissol::dr::initializers::BaseDRInitializer {
public:
 ...
 */
class seissol::dr::initializers::RateAndStateFL103TPInitializer : public seissol::dr::initializers::RateAndStateFL103Initializer {
public:
  virtual void initializeFrictionMatrices(seissol::initializers::DynamicRupture *dynRup,
                                          seissol::initializers::LTSTree* dynRupTree,
                                          seissol::dr::friction_law::BaseFrictionLaw* FrictionLaw,
