...
void seissol::dr::initializers::RateAndStateFL103Initializer::initializeFrictionMatrices(seissol::initializers::DynamicRupture *dynRup,
...
void seissol::dr::initializers::RateAndStateFL103TPInitializer::initializeFrictionMatrices(seissol::initializers::DynamicRupture *dynRup,
                                                                                 seissol::initializers::LTSTree* dynRupTree,
                                                                                 seissol::dr::friction_law::BaseFrictionLaw* FrictionLaw,
                                                                                 std::unordered_map<std::string, double*> faultParameters, unsigned* ltsFaceToMeshFace,
                                                                                 seissol::Interoperability &e_interoperability) {
  //BaseDrInitializer::initializeFrictionMatrices(dynRup, dynRupTree, faultParameters, ltsFaceToMeshFace, e_interoperability);
  RateAndStateFL103Initializer::initializeFrictionMatrices(dynRup, dynRupTree, FrictionLaw, faultParameters, ltsFaceToMeshFace, e_interoperability);
  ...
  seissol::dr::friction_law::RateAndStateThermalFL103 *SolverFL103 = dynamic_cast<seissol::dr::friction_law::RateAndStateThermalFL103 *>(FrictionLaw);
