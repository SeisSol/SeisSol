...
using products = std::tuple<seissol::initializers::DynamicRupture*,
                            seissol::dr::initializers::BaseDRInitializer*,
                            seissol::dr::friction_law::BaseFrictionLaw*,
                            seissol::dr::output::Output_Base*>;
