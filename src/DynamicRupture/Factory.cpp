...
std::unique_ptr<AbstractFactory> getFactory(std::shared_ptr<dr::DRParameters> drParameters, seissol::SeisSol& seissolInstance) {
  ...
  case FrictionLawType::RateAndStateFastVelocityWeakening:
    return std::make_unique<RateAndStateFastVelocityWeakeningFactory>(drParameters, seissolInstance);
  default:
...
DynamicRuptureTuple NoFaultFactory::produce() {
  return {std::make_unique<seissol::initializers::DynamicRupture>(),
          ...
          std::make_unique<output::OutputManager>(std::make_unique<output::NoFault>(), seissolInstance)};
}
...
DynamicRuptureTuple LinearSlipWeakeningFactory::produce() {
  return {std::make_unique<seissol::initializers::LTSLinearSlipWeakening>(),
          ...
          std::make_unique<
              ...
              drParameters.get()),
          std::make_unique<output::OutputManager>(std::make_unique<output::LinearSlipWeakening>(), seissolInstance)};
}
...
DynamicRuptureTuple RateAndStateAgingFactory::produce() {
  if (drParameters->isThermalPressureOn) {
    ...
    return {
        ...
        std::make_unique<output::OutputManager>(std::make_unique<output::RateAndState>(), seissolInstance)};
  }
}
...
DynamicRuptureTuple LinearSlipWeakeningBimaterialFactory::produce() {
  ...
  return {std::make_unique<seissol::initializers::LTSLinearSlipWeakeningBimaterial>(),
          std::make_unique<initializers::LinearSlipWeakeningBimaterialInitializer>(drParameters, seissolInstance),
...
DynamicRuptureTuple ImposedSlipRatesYoffeFactory::produce() {
  return {
      ...
      std::make_unique<initializers::ImposedSlipRatesYoffeInitializer>(drParameters, seissolInstance),
      std::make_unique<friction_law::ImposedSlipRates<friction_law::YoffeSTF>>(drParameters.get()),
      std::make_unique<output::OutputManager>(std::make_unique<output::ImposedSlipRates>(), seissolInstance)};
}
...
DynamicRuptureTuple ImposedSlipRatesGaussianFactory::produce() {
  return {std::make_unique<seissol::initializers::LTSImposedSlipRatesGaussian>(),
          std::make_unique<initializers::ImposedSlipRatesGaussianInitializer>(drParameters, seissolInstance),
...
DynamicRuptureTuple RateAndStateFastVelocityWeakeningFactory::produce() {
  if (drParameters->isThermalPressureOn) {
    return {
        ...
        std::make_unique<initializers::RateAndStateThermalPressurizationInitializer>(drParameters, seissolInstance),
        std::make_unique<
    ...
    return {std::make_unique<seissol::initializers::LTSRateAndStateFastVelocityWeakening>(),
            std::make_unique<initializers::RateAndStateFastVelocityInitializer>(drParameters, seissolInstance),
