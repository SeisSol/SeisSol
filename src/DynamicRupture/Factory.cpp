    ...
    if (drParameters->isThermalPressureOn) {
      return {
          ...
          std::make_unique<seissol::dr::initializer::RateAndStateThermalPressurizationInitializer>(
              drParameters, seissolInstance),
          friction_law::makeFrictionSolverFactory<friction_law_cpu::AgingLaw<friction_law_cpu::ThermalPressurization>>(
              drParameters.get()),
          friction_law::makeFrictionSolverFactory<friction_law_gpu::AgingLaw<friction_law_gpu::ThermalPressurization>>(
              drParameters.get()),
          std::make_unique<seissol::dr::output::OutputManager>(
      ...
      return {
          std::make_unique<seissol::LTSRateAndState>(drParameters.get()),
          std::make_unique<seissol::dr::initializer::RateAndStateInitializer>(drParameters,
                                                                              seissolInstance),
          friction_law::makeFrictionSolverFactory<friction_law_cpu::AgingLaw<friction_law_cpu::NoTP>>(drParameters.get()),
          friction_law::makeFrictionSolverFactory<friction_law_gpu::AgingLaw<friction_law_gpu::NoTP>>(drParameters.get()),
          std::make_unique<seissol::dr::output::OutputManager>(
  ...
  DynamicRuptureTuple produce() override {
    if (drParameters->isThermalPressureOn) {
      return {
          ...
          std::make_unique<seissol::dr::initializer::RateAndStateThermalPressurizationInitializer>(
              drParameters, seissolInstance),
          friction_law::makeFrictionSolverFactory<friction_law_cpu::SlipLaw<friction_law_cpu::ThermalPressurization>>(
              drParameters.get()),
          friction_law::makeFrictionSolverFactory<friction_law_gpu::SlipLaw<friction_law_gpu::ThermalPressurization>>(
              drParameters.get()),
          std::make_unique<seissol::dr::output::OutputManager>(
              std::make_unique<seissol::dr::output::RateAndStateThermalPressurization>(),
              seissolInstance)};
      ...
      return {
          ...
          std::make_unique<seissol::dr::initializer::RateAndStateInitializer>(drParameters,
                                                                              seissolInstance),
          friction_law::makeFrictionSolverFactory<friction_law_cpu::SlipLaw<friction_law_cpu::NoTP>>(drParameters.get()),
          friction_law::makeFrictionSolverFactory<friction_law_gpu::SlipLaw<friction_law_gpu::NoTP>>(drParameters.get()),
          std::make_unique<seissol::dr::output::OutputManager>(
              std::make_unique<seissol::dr::output::RateAndState>(), seissolInstance)};
    }
  }
  ...
  DynamicRuptureTuple produce() override {
    return {std::make_unique<seissol::LTSImposedSlipRatesYoffe>(drParameters.get()),
            std::make_unique<seissol::dr::initializer::ImposedSlipRatesYoffeInitializer>(
                drParameters, seissolInstance),
            friction_law::makeFrictionSolverFactory<friction_law_cpu::ImposedSlipRates<friction_law_cpu::YoffeSTF>>(
                drParameters.get()),
            friction_law::makeFrictionSolverFactory<friction_law_gpu::ImposedSlipRates<friction_law_gpu::YoffeSTF>>(
                drParameters.get()),
            std::make_unique<seissol::dr::output::OutputManager>(
  ...
  DynamicRuptureTuple produce() override {
    return {std::make_unique<seissol::LTSImposedSlipRatesGaussian>(drParameters.get()),
            std::make_unique<seissol::dr::initializer::ImposedSlipRatesGaussianInitializer>(
                drParameters, seissolInstance),
            friction_law::makeFrictionSolverFactory<friction_law_cpu::ImposedSlipRates<friction_law_cpu::GaussianSTF>>(
                drParameters.get()),
            friction_law::makeFrictionSolverFactory<friction_law_gpu::ImposedSlipRates<friction_law_gpu::GaussianSTF>>(
                drParameters.get()),
            std::make_unique<seissol::dr::output::OutputManager>(
                std::make_unique<seissol::dr::output::ImposedSlipRates>(), seissolInstance)};
  }
  ...
  DynamicRuptureTuple produce() override {
    return {std::make_unique<seissol::LTSImposedSlipRatesDelta>(drParameters.get()),
            std::make_unique<seissol::dr::initializer::ImposedSlipRatesDeltaInitializer>(
                drParameters, seissolInstance),
            friction_law::makeFrictionSolverFactory<friction_law_cpu::ImposedSlipRates<friction_law_cpu::DeltaSTF>>(
                drParameters.get()),
            friction_law::makeFrictionSolverFactory<friction_law_gpu::ImposedSlipRates<friction_law_gpu::DeltaSTF>>(
                drParameters.get()),
            std::make_unique<seissol::dr::output::OutputManager>(
                std::make_unique<seissol::dr::output::ImposedSlipRates>(), seissolInstance)};
  }
    ...
    if (drParameters->isThermalPressureOn) {
      ...
      return {std::make_unique<seissol::LTSRateAndStateFastVelocityWeakening>(drParameters.get()),
              std::make_unique<seissol::dr::initializer::RateAndStateFastVelocityInitializer>(
                  drParameters, seissolInstance),
              friction_law::makeFrictionSolverFactory<friction_law_cpu::FastVelocityWeakeningLaw<friction_law_cpu::NoTP>>(
                  drParameters.get()),
              friction_law::makeFrictionSolverFactory<friction_law_gpu::FastVelocityWeakeningLaw<friction_law_gpu::NoTP>>(
                  drParameters.get()),
              std::make_unique<seissol::dr::output::OutputManager>(
                  std::make_unique<seissol::dr::output::RateAndState>(), seissolInstance)};
    }
  ...
  DynamicRuptureTuple produce() override {
    if (drParameters->isThermalPressureOn) {
      return {
          ...
          std::make_unique<seissol::dr::initializer::RateAndStateThermalPressurizationInitializer>(
              drParameters, seissolInstance),
          friction_law::makeFrictionSolverFactory<friction_law_cpu::SevereVelocityWeakeningLaw<
              friction_law_cpu::ThermalPressurization>>(drParameters.get()),
          friction_law::makeFrictionSolverFactory<friction_law_gpu::SevereVelocityWeakeningLaw<
      ...
      return {
          ...
          std::make_unique<seissol::dr::initializer::RateAndStateInitializer>(drParameters,
                                                                              seissolInstance),
          friction_law::makeFrictionSolverFactory<friction_law_cpu::SevereVelocityWeakeningLaw<friction_law_cpu::NoTP>>(
              drParameters.get()),
          friction_law::makeFrictionSolverFactory<friction_law_gpu::SevereVelocityWeakeningLaw<friction_law_gpu::NoTP>>(
              drParameters.get()),
          std::make_unique<seissol::dr::output::OutputManager>(
              std::make_unique<seissol::dr::output::RateAndState>(), seissolInstance)};
    }
