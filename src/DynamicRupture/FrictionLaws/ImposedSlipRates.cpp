...
void seissol::dr::friction_law::ImposedSlipRates::copyLtsTreeToLocal(seissol::initializers::Layer &layerData,
...
void seissol::dr::friction_law::ImposedSlipRates::evaluate(seissol::initializers::Layer&  layerData,
                                                           seissol::initializers::DynamicRupture *dynRup,
