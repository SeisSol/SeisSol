#ifndef SEISSOL_ADJOINTRSF_H
#define SEISSOL_ADJOINTRSF_H
...
class AdjointRSFBase : public BaseFrictionLaw<AdjointRSFBase<Derived, TPMethod>> {
  public:
  explicit AdjointRSFBase(seissol::initializer::parameters::DRParameters* drParameters)
      : BaseFrictionLaw<AdjointRSFBase<Derived, TPMethod>>::BaseFrictionLaw(drParameters),
