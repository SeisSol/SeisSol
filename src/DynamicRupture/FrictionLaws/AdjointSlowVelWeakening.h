#ifndef SEISSOL_ADJOINTSLOWVELWEAKENINGLAW_H
#define SEISSOL_ADJOINTSLOWVELWEAKENINGLAW_H

#include "AdjointRSF.h"

namespace seissol::dr::friction_law {
template <class Derived, class TPMethod>
class AdjointSlowVelWeakening
    : public AdjointRSFBase<AdjointSlowVelWeakening<Derived, TPMethod>, TPMethod> {
  public:
  using AdjointRSFBase<AdjointSlowVelWeakening, TPMethod>::AdjointRSFBase;
...
#endif // SEISSOL_ADJOINTSLOWVELWEAKENINGLAW_H
