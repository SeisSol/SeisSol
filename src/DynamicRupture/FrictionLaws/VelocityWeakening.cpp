...
//          slipRateMagnitude[ltsFace][pointIndex] =
//          std::abs(slipRateMagnitude[ltsFace][pointIndex]);
...
//          //!             f = (mu*initialPressure-|S_0|)*S_0/|S_0|     (Coulomb's model of
//          friction)
...
//
//        // Update slip rate (notice that localSlipRate(T=0)=-2c_s/mu*s_xy^{Godunov} is the slip
//        rate
