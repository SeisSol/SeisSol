 ...
 */
template <class Derived>
class seissol::dr::friction_law::RateAndStateSolver : public seissol::dr::friction_law::BaseFrictionLaw {
 ...
 */
class seissol::dr::friction_law::RateAndStateNucFL103 : public seissol::dr::friction_law::RateAndStateSolver<seissol::dr::friction_law::RateAndStateNucFL103> {
protected:
  //Attributes
...
public:
   ...
   */
  void resampleStateVar(real deltaStateVar[numOfPointsPadded],
                        unsigned int ltsFace);
...
class seissol::dr::friction_law::RateAndStateThermalFL103 : public seissol::dr::friction_law::RateAndStateNucFL103 {
protected:
