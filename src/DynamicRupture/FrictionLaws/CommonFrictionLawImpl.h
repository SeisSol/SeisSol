#ifndef SEISSOL_COMMONFRICTIONLAW_H
#define SEISSOL_COMMONFRICTIONLAW_H
 ...
 */
class CommonFrictionLawImpl : public FrictionSolver {
public:
  CommonFrictionLawImpl(dr::DRParameters& drParameters) : drParameters(drParameters){};
...
#endif //SEISSOL_COMMONFRICTIONLAW_H
