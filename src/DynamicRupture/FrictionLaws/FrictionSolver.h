...
class FrictionSolver {
  ...
  explicit FrictionSolver(seissol::initializer::parameters::DRParameters* userDRParameters)
    ...
    std::copy(&init::quadweights::Values[init::quadweights::Start[seissol::multisim::BasisFunctionDimension]],
              &init::quadweights::Values[init::quadweights::Stop[seissol::multisim::BasisFunctionDimension]],
              &spaceWeights[0]);
  }
