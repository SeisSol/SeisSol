...
namespace {
    ...
    static std::pair<std::size_t, seissol::SupportedConfigs> testConfig(const std::string& material, const std::string& precision, int order, bool plasticity) {
