...
#ifndef SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERCOSTMODEL_H_
#define SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERCOSTMODEL_H_
...
#endif // SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERCOSTMODEL_H_
