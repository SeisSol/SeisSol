...
#ifndef SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERLADDER_H_
#define SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERLADDER_H_
...
#endif // SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERLADDER_H_
