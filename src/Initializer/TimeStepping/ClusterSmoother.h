...
#ifndef SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERSMOOTHER_H_
#define SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERSMOOTHER_H_
...
#endif // SEISSOL_SRC_INITIALIZER_TIMESTEPPING_CLUSTERSMOOTHER_H_
