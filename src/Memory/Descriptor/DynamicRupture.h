...
struct DynamicRupture {
  ...
  Variable<real*>
      timeDerivativePlus; /// \todo (VK) dont know the size of this, change to an array later. This is still the fused time derivative
  Variable<real*>
      timeDerivativeMinus; /// \todo (VK) dont know the size of this, change to an array later. This is still the fused time derivative
  Variable<real*>
      timeDerivativePlusDevice; /// \todo (VK) dont know the size of this, change to an array later. This is still the fused time derivative
  Variable<real*>
      timeDerivativeMinusDevice; /// \todo (VK) dont know the size of this, change to an array later. This is still the fused time derivative
