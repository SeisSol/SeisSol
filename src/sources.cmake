...
elseif("${DEVICE_BACKEND}" STREQUAL "ONEAPI")
  ...
  target_link_libraries(Seissol-device-lib PUBLIC sycl "-fsycl" "-fsycl-targets=spir64_gen-unknown-unknown-sycldevice" "-fsycl-unnamed-lambda")
  target_link_libraries(SeisSol-lib PUBLIC Seissol-device-lib "-fsycl" "-fsycl-targets=spir64_gen-unknown-unknown-sycldevice" "-fsycl-unnamed-lambda")
  add_dependencies(Seissol-device-lib SeisSol-lib)
