...
#ifndef SEISSOL_SRC_TESTS_INITIALIZER_TIME_STEPPING_LTSWEIGHTS_T_H_
#define SEISSOL_SRC_TESTS_INITIALIZER_TIME_STEPPING_LTSWEIGHTS_T_H_
...
#endif // SEISSOL_SRC_TESTS_INITIALIZER_TIME_STEPPING_LTSWEIGHTS_T_H_
